      ...
      <tbody>
        <template v-if="noticeList">
          <template v-if="noticeList.noticeCnt > 0">
            <tr v-for="notice in noticeList.notice" :key="notice.noticeIdx" v-on:click="handlerModal(notice.noticeIdx)">
...
const searchList = () => {
  ...
  axios.post("/api/board/noticeListBody.do", param).then((res) => {
