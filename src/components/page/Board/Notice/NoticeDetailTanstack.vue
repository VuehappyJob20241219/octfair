  ...
  <div>
    ...
    <div v-else>
      ...
      <div class="button-box">
        <button
          v-if="userInfo.user.userType === 'M'"
          @click="detailValue.noticeIdx ? handlerUpdateNoticeBtn() : handlerSaveNoticeBtn()"
        >
          {{ detailValue.noticeIdx ? "수정" : "저장" }}
        </button>
        <button @click="handlerDeleteNoticeBtn" v-if="userInfo.user.userType === 'M' && detailValue.noticeIdx">
          삭제
        </button>
